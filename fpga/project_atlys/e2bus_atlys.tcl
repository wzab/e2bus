# 
# Project automation script for e2bus_atlys 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source e2bus_atlys.tcl), then you can
...
set myProject "e2bus_atlys"
set myScript "e2bus_atlys.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../extbus/general-cores/genrams/genram_pkg.vhd"
   xfile add "../extbus/general-cores/wishbone/wb_crossbar/xwb_crossbar.vhd"
   xfile add "../extbus/general-cores/wishbone/wb_i2c_master/i2c_master_bit_ctrl.vhd"
   xfile add "../extbus/general-cores/wishbone/wb_i2c_master/i2c_master_byte_ctrl.vhd"
   xfile add "../extbus/general-cores/wishbone/wb_i2c_master/i2c_master_top.vhd"
   xfile add "../extbus/general-cores/wishbone/wishbone_pkg.vhd"
   xfile add "../extbus/main.vhd"
   xfile add "../extbus/wb_gener/agwb_main_const_pkg.vhd"
   xfile add "../extbus/wb_gener/agwb_main_wb.vhd"
   xfile add "../extbus/wb_gener/agwb_main_wb_pkg.vhd"
   xfile add "../extbus/wishbone_wb_pkg.vhd"
   xfile add "../src/atlys/atlys_eth.ucf"
   xfile add "../src/atlys/atlys_eth_top.vhd"
   xfile add "../src/atlys/ip_atlys/cmd_ack_fifo.xco"
   xfile add "../src/atlys/ip_atlys/cmd_desc_dpr.xco"
   xfile add "../src/atlys/ip_atlys/cmd_frm_dpr.xco"
   xfile add "../src/atlys/ip_atlys/dcm1.xco"
   xfile add "../src/atlys/ip_atlys/resp_ack_dpr.xco"
   xfile add "../src/atlys/ip_atlys/resp_dpr.xco"
   xfile add "../src/cmd_exec_wb.vhd"
   xfile add "../src/e2bus.vhd"
   xfile add "../src/e2bus_pkg.vhd"
   xfile add "../src/eth1g/dpr_eth_receiver.vhd"
   xfile add "../src/eth1g/dpr_eth_sender.vhd"
   xfile add "../src/eth1g/pkg_newcrc32_d8.vhd"
   xfile add "../src/sync_stlv.vhd"
   xfile add "../src/wb_ctrl.vhd"
   xfile add "../src/wb_pkg.vhd"
   xfile add "../src/wb_test.vhd"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/tmp/fpga_xl/project_atlys/e2bus_atlys/xst" -process "Synthesize - XST"
